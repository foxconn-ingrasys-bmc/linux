...
#define JTAG_SW_MODE_TCK		SOFTWARE_TCK_BIT
#define JTAG_SW_MODE_TMS		SOFTWARE_TMS_BIT
#define JTAG_SW_MODE_TDIO		SOFTWARE_TDIO_BIT
...
#ifdef INTEL_JTAG_ADDITIONS
extern long intel_jtag_ioctl(unsigned int cmd, unsigned long arg);
extern int intel_jtag_init(void);
extern void intel_jtag_exit(void);
#endif
